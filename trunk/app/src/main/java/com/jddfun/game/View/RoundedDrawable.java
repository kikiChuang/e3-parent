...
public class RoundedDrawable extends Drawable {
  ...
  public RoundedDrawable(Bitmap bitmap, boolean grey) {
  ...
  public static RoundedDrawable fromBitmap(Bitmap bitmap, boolean grey) {
    if (bitmap != null) {
      return new RoundedDrawable(bitmap, grey);
    } else {
      return null;
    }
  }

  public static Drawable fromDrawable(Drawable drawable, boolean grey) {
    if (drawable != null) {
      if (drawable instanceof RoundedDrawable) {
        ...
        for (int i = 0; i < num; i++) {
          ...
          ld.setDrawableByLayerId(ld.getId(i), fromDrawable(d, grey));
        }
        return ld;
      }
      ...
      if (bm != null) {
        return new RoundedDrawable(bm, grey);
      } else {
  ...
  public static Bitmap drawableToBitmap(Drawable drawable) {
    ...
    try {
      bitmap = Bitmap.createBitmap(200, 200, Config.RGB_565);
