...
public class RoundedImageView extends ImageView {
    ...
    private boolean unconsumeEvents;
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        isOval = a.getBoolean(R.styleable.RoundedImageView_isoval, false);
    ...
    public void setImageDrawable(Drawable drawable) {
        mResource = 0;
        mDrawable = RoundedDrawable.fromDrawable(drawable, isGrey);
        updateDrawableAttrs();
    ...
    public void setImageBitmap(Bitmap bm) {
        mResource = 0;
        mDrawable = RoundedDrawable.fromBitmap(bm, isGrey);
        updateDrawableAttrs();
        super.setImageDrawable(mDrawable);
    }
    ...
    private Drawable resolveResource() {
        ...
        return RoundedDrawable.fromDrawable(d, isGrey);
    }
    ...
    private void updateBackgroundDrawableAttrs(boolean convert) {
        if (mutateBackground) {
            if (convert) {
                mBackgroundDrawable = RoundedDrawable.fromDrawable(mBackgroundDrawable, isGrey);
            }
    ...
    public void setProportion(float x, float y) {
        proportion = y / x;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (proportion != 0.0)
            currentHeight = (int) ((float) currentWidth * proportion);
        setMeasuredDimension(currentWidth, currentHeight);
    }

    /*
     */
    public void setUnconsumeEvents(boolean unconsumeEvents) {
        this.unconsumeEvents = unconsumeEvents;
    }
